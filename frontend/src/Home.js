...
const Home = () => {
    ...
    const [ state, setState ] = useState({'minPrice':0, 'maxPrice': 15});
    
    const onKeyDown = (e) => {
        if (e.key === 'Enter') {
            history.push(`/choose/${e.target.value}/${state['minPrice']}/${state['maxPrice']}`);
        }
    };
    ...
    return (
        <div className="home">
            ...
            <PriceSlider setSearchState={setState} />
            <div className="search-container">
                ...
                <input placeholder="Chicken with rice" type="text" className="search-bar" onKeyDown={onKeyDown}></input>
